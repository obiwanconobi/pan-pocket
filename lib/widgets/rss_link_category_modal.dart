...
class RssLinkCategoryModal extends StatefulWidget {
  const RssLinkCategoryModal({super.key});

  @override
  State<RssLinkCategoryModal> createState() => _RssLinkCategoryModalState();
}

class _RssLinkCategoryModalState extends State<RssLinkCategoryModal> with SingleTickerProviderStateMixin {
